...
import cameratest.example.com.cameratest.util.CompareSizesByArea;
...
public class CameraOpenHelper {
    ...
    private CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice camera) {
            final OverCamera overCamera = new OverCamera(camera, mCameraCharacteristics, mCurrentOutputSize, mMainHandler);
            mMainHandler.post(new Runnable() {
                @Override
                public void run() {
                    if (mOnCameraOpenCallback != null) {
                        mOnCameraOpenCallback.onCameraOpened(overCamera, mPreviewSize);
                    }
                }
            });
        }
...
//                        maxPreviewHeight, 16, 9);
    ...
    public interface OnCameraOpenCallback {
        void onCameraOpened(OverCamera camera, Size previewSize);
