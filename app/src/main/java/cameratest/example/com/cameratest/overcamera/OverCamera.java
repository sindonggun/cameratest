...
import cameratest.example.com.cameratest.util.AutoFocusHelper;
import cameratest.example.com.cameratest.util.CameraUtil;
...
public class OverCamera implements CameraPrototype {

    private static final String TAG = "OverCamera";
...
//            Log.d(TAG, "process: state->"+state.name());
    ...
    public OverCamera(
        ...
        mCameraThread = new HandlerThread("OverCamera");
        mCameraThread.start();
    ...
    private boolean sendRepeatPreviewRequest() {
        try {
            ...
            builder.setTag(cameratest.example.com.cameratest.overcamera.OverCamera.RequestTag.Preview);
    ...
    private void takePictureNow(PhotoCaptureParameters parameters) {
        ...
        try {
            ...
            builder.setTag(cameratest.example.com.cameratest.overcamera.OverCamera.RequestTag.Capture);
            addBaselineCaptureKeysToRequest(builder);
